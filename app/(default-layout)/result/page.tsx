...
const mockVideos: Video[] = [
  ...
  },
  {
    ...
    title: "Short Video",
    time: 60,
    description: "This is a short video.",
    fileUrl: "/video-demo.mp4",
    thumbnailUrl: "/imgs/placeholder.svg",
    tags: mockTags,
    userId: mockUser,
  ...
  },
  {
    ...
    time: 90,
    description: "This is another short video.",
    fileUrl: "/video-demo.mp4",
    thumbnailUrl: "/imgs/placeholder.svg",
    tags: mockTags,
    userId: mockUser,
...
export default function ResultPage() {
  return (
    <div className="w-full grid grid-cols-5">
      <div className="col-span-full xl:col-span-4 max-w-7xl flex flex-col gap-4 mx-auto py-4 px-8 sm:px-4">
        ...
        <Paginator
          items={mockVideos}
          itemsPerPage={3}
          renderItem={(video) => <DetailVideoCard video={video} />}
        />
      </div>
      <div className="relative hidden xl:flex xl:col-span-1 flex-col">
        <div className="sticky top-46 w-full h-auto flex flex-col gap-4 p-4 items-center">
          ...
          <p className="text-sm line-clamp-3 text-muted-foreground">
            ...
            network of agents and personnel to locate and contain these
            anomalies, ensuring that they do not pose a threat to humanity.
          </p>
