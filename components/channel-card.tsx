        ...
        <CardContent className="flex flex-col gap-8">
          ...
          <div className="flex flex-row items-center gap-4">
            <div className="flex flex-col text-center gap-2">
              ...
              <CardTitle className="text-2xl">{channel.progress.subscribers.length}</CardTitle>
            </div>

            <div className="flex flex-col text-center gap-2">
              <CardTitle>Videos</CardTitle>
              <CardTitle className="text-2xl">{channel.progress.uploadedVideos.length}</CardTitle>
            </div>
          </div>
        </CardContent>
      </div>
